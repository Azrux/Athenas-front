...
export default function AboutUs() {
	...
	const KnowMoreColor = theme === "dark" ? "secondary" : "primary";
	const knowMoreTextcolor =
		theme === "dark" ? "text-default" : "text-secondary";

	return (
		<div className="container mx-auto py-12 px-4 bg-background-primary">
			...
			<Card className="mt-8 border-violet-300 bg-violet-100">
				...
				<CardBody className="flex flex-col md:flex-row items-center gap-4">
					...
					<div>
						<p className="text-black mb-4">
							{aboutUsTexts.joinUsText}
						</p>
						<Button
							color={KnowMoreColor}
							className={knowMoreTextcolor}
							variant="shadow"
						>
